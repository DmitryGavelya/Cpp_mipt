...
//  ------------------------------------------------------------------------------------------
    ...
    using MyDeque = Deque<int, double, char>;

    static_assert(has_v<int, MyDeque> == true);
    static_assert(has_v<double, MyDeque> == true);
    static_assert(has_v<char, MyDeque> == true);
    static_assert(has_v<float, MyDeque> == false);
